...
import GuestLayout from "@/Layouts/GuestLayout_key_code.vue";
import CountDown from "@/Components/CountDown_key_code.vue";
import { ref } from "vue";
...
const showClass_1 = (arr) => {
  if (arr == 0) {
    ...
    var rel =
      "px-1 py-1 text-1xl font-medium text-white bg-blue-400 w-11 whitespace-nowrap dark:text-white dark:bg-gray-800";
  }
  return rel;
};
...
const showClass_2 = (arr) => {
  if (arr == 0) {
    ...
    var rel =
      "px-1 py-0 text-1xl font-medium font-black text-center text-white bg-red-400 w-11 whitespace-nowrap dark:text-white dark:bg-gray-800";
  }
  return rel;
};
