...
import CountDownNotdata from "@/Components/CountDownNotdata_key_code.vue";
import { ref } from "vue";
              ...
              <div id="oopss">
                <div id="error-text">
                  <img
                    ...
                    alt="404"
                  />
                  <span>ไม่พบข้อมูลของทาน</span>
                  <p class="p-a">กรุณาแจ้งหัวหน้าเพื่อตรวจสอบข้อมูล</p>
                  <!-- <p class="p-b">... Back to previous page</p> -->
                  <div class="w-60">
                    <CountDownNotdata :key="componentKey" />
                  </div>
                </div>
              </div>
            </div>
